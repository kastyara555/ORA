...
export const getStreetTypesUrl = BASE_API_URL.concat("/streetTypes");
...
export const getProcedureDataUrl = (procedureId: string) =>
  BASE_API_URL.concat(`/procedure/${procedureId}`);
